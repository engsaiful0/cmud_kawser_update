        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    ?>
                        <!-- Employees -->
                        <li style="display: none;" class="nav-parent <?php if ($main_menu == 'employee') echo 'nav-expanded nav-active'; ?>">
                        ...
                        <li class="nav-parent <?php if (
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php if (get_permission('accounting_reports', 'is_view')) { ?>
                                    <li style="display: none;" class="nav-parent <?php if ($main_menu == 'accounting_repots') echo 'nav-expanded nav-active'; ?>">
